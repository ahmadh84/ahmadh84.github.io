...
\usepackage[left=1.3cm, right=1.3cm, twoside, includeheadfoot=true]{geometry}
\usepackage{relsize}
\usepackage{datetime}
...
\pagestyle{fancy}
\makeatletter
  \lhead[Ahmad Humayun]{R{\'e}sum{\'e} --- \monthyeardate\today}
  \rhead[R{\'e}sum{\'e} --- \monthyeardate\today]{Ahmad Humayun}
  \cfoot{}
...
\renewcommand{\maketitle}{%
	...
	\begin{center}\leavevmode
		\normalfont
		\begin{minipage}[t][0.6cm][l]{0.675\textwidth}
			{\Huge\@title\par}%
		\end{minipage}
		\hfil
		\begin{minipage}[t][0.6cm][l]{0.315\textwidth}
			\raisebox{10pt}{
...
\author{\multicolumn{2}{l}{Google, Mountain View, CA 94043} \\ {\large\Mobilefone} & +1 (404) 398-5465}
...
\vspace{-0.2cm}
\hspace*{-0.25cm} \begin{tabular}[t]{l@{\hspace*{0.25cm}} l@{\hspace*{1.8cm}} l@{\hspace*{0.25cm}} l@{\hspace*{1.7cm}} l@{\hspace*{0.25cm}} l}%
{\large\Letter} & \href{mailto:ahumayun@google.com}{ahumayun@google.com} & {\large\Keyboard} & \textsf{\href{https://ahumayun.com/}{https://ahumayun.com/}} & \raisebox{-0.03cm}{\includegraphics[scale=0.35]{linkedin.png}} & \textsf{\href{http://linkedin.com/in/ahmadhumayun}{http://linkedin.com/in/ahmadhumayun}}
\end{tabular}
...
\ifdetail \textbf{Mentor Graphics Project Award} for AVRiL - best BSc. senior year project (2007). \fi
...
\textbf{Video Segmentation by Tracking Many Figure-Ground Segments}. \ifdetail ($3^{\text{rd}}$ author) \newline \fi \textit{\ifdetail International Conference on Computer Vision (ICCV) \else ICCV \fi} - Dec. '13. \href{https://web.engr.oregonstate.edu/~lif/SegTrack2/}{\ifdetail web.engr.oregonstate.edu/$\sim$lif/SegTrack2/ \else tinyurl.com/2fdx4364 \fi}

\textbf{Learning a Confidence Measure for Optical Flow}. \ifdetail ($2^{\text{nd}}$ author) \newline \fi \textit{\ifdetail IEEE Transactions on Pattern Analysis and Machine Intelligence (PAMI) \else IEEE PAMI \fi} - May '13. \href{http://visual.cs.ucl.ac.uk/pubs/flowConfidence/}{visual.cs.ucl.ac.uk/pubs/flowConfidence}
...
\clearpage
\newgeometry{top=2cm, bottom=2cm, left=1.3cm, right=1.3cm, twoside}
...
Developed an automated \textit{director} that captures a multi-camera lecture environment. %The participants were tracked using computer vision and sound localization techniques. %The system made use of multiple cameras and mathematically modeled direction heuristics for production. 
 \underline{Tools}: OpenCV%, \textsc{.Net}
...
% Founder Professor of Computer Science and Industrial and Enterprise Systems Engineering,\\
% University of Illinois Urbana-Champaign\\
% %85 $5^{\text{th}}$ Street NW,\\
% %Atlanta, GA 30332\\
% %United Stated of America\\
% %\Telefon\ +1 (404) 894-9105\\
% \Letter\ \href{mailto:jrehg@uiuc.edu}{jrehg\textrm{@}uiuc.edu}
% \end{minipage}
% \\
% \\
&
